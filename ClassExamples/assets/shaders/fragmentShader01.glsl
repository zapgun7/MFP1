                            ...
                            vec3 vertexWorldPos, vec4 vertexSpecular )
{
	...
	{	
		...
		if ( intLightType == DIRECTIONAL_LIGHT_TYPE )		// = 2
		{
			...
			return clamp (finalObjectColour + theLights[0].ambient*colour/255, 0.0, 1.0);		
		}
...
//			                   * vertexSpecular.rgb;	//* theLights[lightIndex].Specular.rgb
		...
		{	
			...
			//currentLightRayAngle /= length(vertexToLight.xyz)* length(theLights[index].direction.xyz);
			//currentLightRayAngle = acos(radians(currentLightRayAngle));
			...
			if ( currentLightRayAngle < outerConeAngleCos )
			{
				...
				//lightDiffuseContrib *= theLights[0].ambient.xyz;
		...
		finalObjectColour.rgb += (vertexMaterialColour.rgb * lightDiffuseContrib.rgb * theLights[index].direction.w)
								  + (vertexSpecular.rgb  * lightSpecularContrib.rgb );
		//if (finalObjectColour.rgb == vec3(0.0))
		//{
		//	finalObjectColour.rgb = (vertexMaterialColour.rgb * 0.1);
		//}

	}//for(intindex=0...
	
	finalObjectColour.a = 1.0f;
	//finalObjectColour.rgb += colour.rgb * theLights[0].ambient.rgb/255;
	
	return clamp (finalObjectColour , 0.0, 1.0);	
}
